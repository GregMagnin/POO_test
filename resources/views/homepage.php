...
<body>
    ...
    <ul class="nav">
        ...
        <a href="/panier"> <li class="cart"><img src="/resources/assets/panier.png" alt="PANIER"><p class="numberCart">0</p></li></a>
...
<div id="pagination"> <?php for($i=1;$i<=$pages;$i++){echo"<a href='?page=$i'>$i</a>&nbsp;";}?></div>
