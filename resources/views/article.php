...
<ul class="nav">
    ...
    <div class="containerProducts"> 
        ...
        <div class="description"><?php echo $article['name']; ?> <br><?php echo $article['content']; ?> <br> <?php echo $article['price']?>€ <div class="addCart"><a href="/panier?id=<?php echo $article['ID'] ?>&price=<?php echo $article['price'] ?>&article_name=<?php echo $article['name']?>"><button>Ajouter au panier</button></a></div> </div>
